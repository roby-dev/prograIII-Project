...
public class frmAgregarLugar extends javax.swing.JFrame {

    public frmAgregarLugar() {
        initComponents();
        this.setLocationRelativeTo(null);
        btnCerrar.setBorder(new frmAgregarLugar.RoundedBorder(99));
        btnCerrar.setOpaque(false);
        btnCerrar.setBackground(new Color(0, 0, 0, 0));
        btnCerrar.setForeground(Color.WHITE);
        txtLugar.setForeground(Color.gray);
        this.getRootPane().setDefaultButton(btnAgregarLugar);
    ...
    private void initComponents() {
        ...
        btnAgregarLugar.setBackground(new java.awt.Color(3, 55, 86));
        btnAgregarLugar.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        btnAgregarLugar.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jPanel3.add(btnAgregarLugar, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 160, 240, 40));
    ...
    private void btnAgregarLugarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarLugarActionPerformed
        ...
        try {
            if (validarCampos()) {
                if (JOptionPane.showConfirmDialog(null, "Seguro que desea agregar el Lugar", "Pregunta", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE)==0) {
                    objLugar.setNombre(txtLugar.getText());
                    if (objLugar.AgregarLugar(objLugar)){
                        if(JOptionPane.showConfirmDialog(this, "Lugar agregado con exito\n¿Desea agregar otro Lugar?", "Pregunta", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE)==0){
                            Limpiar();
                        }
                        else{
                            this.dispose();
                        ...
                        JOptionPane.showMessageDialog(this, "No se pudo agregar el Lugar, intentelo de nuevo");
                    }
                }
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAgregarLugar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmAgregarLugar().setVisible(true);
            }
        });
    }
