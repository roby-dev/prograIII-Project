...
public class frmModificarUsuario extends javax.swing.JFrame {
    ...
    public frmModificarUsuario() {
        ...
        btnCerrar.setBorder(new frmModificarUsuario.RoundedBorder(99));
        ...
        this.getRootPane().setDefaultButton(btnModificarUsuario);
        Shape forma = new RoundRectangle2D.Double(0, 0, this.getBounds().width, this.getBounds().height, 40, 40);
        AWTUtilities.setWindowShape(this, forma);
        txtNombre.requestFocus();
    }
    int id;
    public frmModificarUsuario(clsUsuario objUsuario) {
        initComponents();this.setLocationRelativeTo(null);
        btnCerrar.setBorder(new frmModificarUsuario.RoundedBorder(99));
        btnCerrar.setOpaque(false);
        btnCerrar.setBackground(new Color(0, 0, 0, 0));
        ...
        txtApellido.setText(objUsuario.getApellido());
        txtUsuario.setText(objUsuario.getUsername());
        txtEmail.setText(objUsuario.getEmail());
        cmbTipo.setSelectedIndex(objUsuario.getTipo());
        cmbEstado.setSelectedIndex(objUsuario.getEstado());
    }
    ...
    private void initComponents() {
        ...
        btnModificarUsuario.setBackground(new java.awt.Color(3, 55, 86));
        btnModificarUsuario.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        ...
        jPanel3.add(btnModificarUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 520, 240, 40));
        ...
        jPanel3.add(cmbEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 450, 370, 40));
        ...
        jPanel3.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 460, 130, -1));
    ...
    private void btnModificarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarUsuarioActionPerformed
        ...
        try {
            if (validarCampos()) {
                if (comprobarClaves()) {
                    if (JOptionPane.showConfirmDialog(null, "Seguro que desea modificar el Usuario", "Pregunta", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE)==0) {
                        objUsuario.setId(id);
                        ...
                        objUsuario.setEstado(cmbEstado.getSelectedIndex());
                        if (objUsuario.ModificarUsuario(objUsuario)){
                            JOptionPane.showMessageDialog(this, "Usuario modificado con exito");
                            this.dispose();
                        } else {
                            JOptionPane.showMessageDialog(this, "No se pudo modificar el Usuario, intentelo de nuevo");
                        }
                    }
                } 
                else {
