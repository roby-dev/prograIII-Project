...
public class frmAgregarPregunta extends javax.swing.JFrame {
    ...
    public frmAgregarPregunta() {
        ...
        btnCerrar.setBorder(new frmAgregarPregunta.RoundedBorder(99));
        btnCerrar.setOpaque(false);
        btnCerrar.setBackground(new Color(0, 0, 0, 0));
        btnCerrar.setForeground(Color.WHITE);
        txtPregunta.setForeground(Color.gray);
        this.getRootPane().setDefaultButton(btnAgregarPregunta);
    ...
    private void initComponents() {
        ...
        btnAgregarPregunta.setBackground(new java.awt.Color(3, 55, 86));
        btnAgregarPregunta.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        ...
        jPanel3.add(btnAgregarPregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 160, 240, 40));
    ...
    private void btnAgregarPreguntaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarPreguntaActionPerformed
        ...
        try {
            System.out.println(txtPregunta.getText());
            if (validarCampos()) {
                if (JOptionPane.showConfirmDialog(null, "Seguro que desea agregar la Pregunta", "Pregunta", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE)==0) {
                    objPregunta.setDescripcion(txtPregunta.getText());
                    if (objPregunta.AgregarPregunta(objPregunta)){
                        if(JOptionPane.showConfirmDialog(this, "Pregunta Agregada con exito\n¿Desea agregar otra Pregunta?", "Pregunta", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE)==0){
                            Limpiar();
                        }
                        else{
                            this.dispose();
                        ...
                        JOptionPane.showMessageDialog(this, "No se pudo agregar la Pregunta, intentelo de nuevo");
                    }
                }
            }
            else{
